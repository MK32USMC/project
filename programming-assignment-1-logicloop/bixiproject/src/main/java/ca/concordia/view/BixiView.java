...
/**
 * Console-based UI for the BIXI data analysis tool.
 * Presents a menu and delegates all logic to BixiController.
 */
public class BixiView {
    ...
    public void start() {
        System.out.println("╔══════════════════════════════════════╗");
        System.out.println("║     BIXI Data Analyzer — COEN 352    ║");
        System.out.println("╚══════════════════════════════════════╝");
    ...
    private void handleReq7() {
        ...
        try {
            ...
            if (rushHour >= 0) {
                System.out.printf("Rush hour for month %d: %02d:00 – %02d:00%n",
                        month, rushHour, rushHour + 1);
            }
        } catch (NumberFormatException e) {
            System.out.println("Invalid number: " + input);
        }
